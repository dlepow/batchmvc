...
namespace BatchDotnetTutorialFfmpeg
{
    ...
    class Program
    {
        ...
        // Pool and Job IDs
        private const string PoolId = "WinFFmpegPool3";
        private const string JobId = "WinFFmpegJob3";
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (BatchClient batchClient = BatchClient.Open(sharedKeyCredentials))
                {
                    ...
                    // DownloadBlobsFromContainer(blobClient, outputContainerName, Environment.GetEnvironmentVariable("TEMP"));
